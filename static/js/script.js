const ToDos = {
    ...
    async fillTodosList(todos) {
        for (const todo of todos) {
            ...
            if(todoItem)
            {
                ...
                button_rem.classList.add('btn-danger');
                button_rem.classList.add('btn-sm');
                ...
                <div class="modal fade" id="edit-todo-window${id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <button type="button" class="btn btn-dark" data-dismiss="modal"> <b>Отмена</b></button>
                        <button type="button" class="btn btn-primary" id='save-todo-edit${id}'><b>Сохранить</b></button>
                        </div>
                    </div>
                    </div>
                </div>
    ...
    async NoNameDes() {
        if (!confirm('Название и описание задачи не могут быть пустыми')) {
            return;
        }
    },
